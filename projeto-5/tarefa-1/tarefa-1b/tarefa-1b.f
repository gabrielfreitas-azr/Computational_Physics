     ...
     &               19.2d0, 30.1d0/)
      ...
      open(12, file = 'tarefa-1b-saida-2.dat')
      open(13, file = 'tarefa-1b-saida-3.dat')      
      open(14, file = 'tarefa-1b-saida-4.dat')      
      open(15, file = 'tarefa-1b-saida-5.dat')      
      open(16, file = 'tarefa-1b-saida-6.dat')      
      open(17, file = 'tarefa-1b-saida-7.dat')      
      open(18, file = 'tarefa-1b-saida-8.dat') 
      
      !     Arquivos de saída para o método de Euler-Cromer.
      
      open(19, file = 'tarefa-1b-saida-9.dat')
      open(20, file = 'tarefa-1b-saida-10.dat')
      open(21, file = 'tarefa-1b-saida-11.dat')      
      open(22, file = 'tarefa-1b-saida-12.dat')      
      open(23, file = 'tarefa-1b-saida-13.dat')      
      open(24, file = 'tarefa-1b-saida-14.dat')      
      open(25, file = 'tarefa-1b-saida-15.dat')      
      open(26, file = 'tarefa-1b-saida-16.dat')   
