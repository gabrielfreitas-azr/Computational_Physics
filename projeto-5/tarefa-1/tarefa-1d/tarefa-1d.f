     ...
     &               19.2d0, 30.1d0/)
      ...
      open(11, file = 'tarefa-1d-saida-1.dat')
      open(12, file = 'tarefa-1d-saida-2.dat')
      open(13, file = 'tarefa-1d-saida-3.dat')      
      open(14, file = 'tarefa-1d-saida-4.dat')      
      open(15, file = 'tarefa-1d-saida-5.dat')      
      open(16, file = 'tarefa-1d-saida-6.dat')      
      open(17, file = 'tarefa-1d-saida-7.dat')      
      open(18, file = 'tarefa-1d-saida-8.dat') 
      
      !     Arquivos de saída para o método de Euler-Cromer.
      
      open(19, file = 'tarefa-1d-saida-9.dat')
      open(20, file = 'tarefa-1d-saida-10.dat')
      open(21, file = 'tarefa-1d-saida-11.dat')      
      open(22, file = 'tarefa-1d-saida-12.dat')      
      open(23, file = 'tarefa-1d-saida-13.dat')      
      open(24, file = 'tarefa-1d-saida-14.dat')      
      open(25, file = 'tarefa-1d-saida-15.dat')      
      open(26, file = 'tarefa-1d-saida-16.dat')   
      ...
      do i = 1, 8
         ...
         call velvet_method(i + 10, a(i), 1.d-4, 25.d0)
         close(i + 10)
      ...
      do i = 1, 8
         ...
         call ecromer_method(i + 18, a(i), 1.d-4, 25.d0)
         close(i + 18)
         
      end do 
      
      end program tarefa1d
      ...
      subroutine ecromer_method(nfile, x0, dtau, tau_m) 
      implicit real*8(a-h, o-z)
      ...
      function energy(rho, v)
      implicit real*8(a-h, o-z)
      
      energy = 0.5d0 * v**2.d0 - 1.d0 / rho
      return
      end function energy
